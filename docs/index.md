---
home: true
# heroImage: https://cdn.jsdelivr.net/gh/NorwegianWood1208/jerry-gitalk-blog@main/j_by_climei.png
heroText: Jerry's blog
tagline: 个人博客：博观约取，厚积薄发，愿大家都能永远不忘学习永远热爱生活。
# actionText: 立刻进入 →
# actionLink: /web/
# bannerBg: /img/bg.jpeg 
features: # 可选的
  - title: 读书
    details: 分享自己比较片面的读书笔记和心得
    link: /read/ # 可选
    imgUrl: /img/read.png # 可选
  - title: 生活
    details: 旅行、美食、音乐，总之就是要热爱生活
    link: /life/
    imgUrl: /img/Rock.png
  - title: 技术
    details: 菜鸡前端一枚，不定时分享技术
    link: /technology/
